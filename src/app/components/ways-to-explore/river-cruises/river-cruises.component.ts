...
@Component({
  selector: 'app-river-cruises',
  standalone: true,
  imports: [SearchBarComponent, MatTabsModule],
  templateUrl: './river-cruises.component.html',
  styleUrl: './river-cruises.component.css',
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class RiverCruisesComponent implements AfterViewInit {
